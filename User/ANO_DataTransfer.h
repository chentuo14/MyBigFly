#ifndef __ANO_DATATRANSFER_H_
#define __ANO_DATATRANSFER_H_
...
#define STATUS_LENGTH	17
#define SENSER_LENGTH	23
#define RCDATA_LENGTH	25
#define MOTO_LENGTH		21
